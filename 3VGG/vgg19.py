...
def vgg19_model(img_rows, img_cols, channel=1, num_classes=None):
    ...
    model.load_weights('/home/cnd/.keras/models/vgg19_weights_tf_dim_ordering_tf_kernels.h5')
...
if __name__ == '__main__':
    ...
    # use keras VGG19 without weights
    # model = VGG19(include_top=True, weights=None, classes=10)
    # sgd = SGD(lr=1e-3, decay=1e-6, momentum=0.9, nesterov=True)
    # model.compile(optimizer=sgd, loss='categorical_crossentropy', metrics=['accuracy'])
